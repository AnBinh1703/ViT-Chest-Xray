...
\graphicspath{{./}{../image/}{../../image/}{image/}{./image/}{../../}}
...
\begin{titlepage}
  ...
  \safeincludegraphics[width=0.18\textwidth]{../image/fsb.png}
...
\begin{figure}[H]
  \centering
  \safeincludegraphics[width=0.85\textwidth]{../image/output_cnn.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.85\textwidth]{../image/output-resnet.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.85\textwidth]{../image/output-vit-resnet.png}
...
%----------------------------------------------------------
\section{Tổng hợp Kết quả Trực quan}
...
\begin{table}[H]
\centering
\caption{Danh sách hình ảnh kết quả thực nghiệm}
