...
% Giảm khoảng trống trước chapter/section headings
\usepackage{titlesec}
...
\begin{titlepage}
  ...
  % Logo FPT University - Placeholder (replace fpt_logo.png with a valid image)
  % \includegraphics[width=0.5\textwidth]{../../image/fpt_logo.png}
  
  \vspace{2cm}
  {\Huge \textbf{FPT UNIVERSITY}}\\
  {\Large \textbf{FPT Education}}
  \vspace{1cm}
  ...
  {\normalsize University of Toronto}\\[1
  cm]
...
% ============================================================
\section{Phương pháp dựa trên CNN (CNN-based Methods)}
\label{sec:rw_cnn}

\subsection{ChestX-ray14 và CheXNet}
...
\subsection{CheXpert và Uncertainty Labeling}
...
\subsection{MIMIC-CXR và Vision-Language Models}
...
% ============================================================
\section{Kiến trúc Transformer cho Thị giác Y tế}
...
% ============================================================
\section{Xử lý Mất Cân Bằng Lớp (Class Imbalance Handling)}
...
\subsection{Class-Balanced Sampling và Re-weighting}
...
% ============================================================
\section{Khả năng Diễn Giải Mô Hình (Model Explainability)}
\label{sec:rw_explainability}

\subsection{Grad-CAM và Variants}
...
\subsection{Attention Maps trong Transformer}
...
% ============================================================
\section{Nghiên Cứu So Sánh Kiến Trúc}
\label{sec:rw_comparison}

\subsection{CNN vs Transformer trong Y Tế}
...
\subsection{Bài Báo Gốc (Paper Under Analysis)}
...
% ============================================================
\section{Gaps và Đóng Góp của Luận Văn Này}
\label{sec:rw_gaps}

\subsection{Gaps trong Literature}
...
\subsection{Đóng Góp của Luận Văn}
...
\subsection{Per-Class AUC: Best Model (ViT Final)}
...
\subsection{Phân tích chi tiết theo nhóm}

\subsubsection{Nhóm 1: Bệnh hiếm (Rare Diseases)}
...
\subsubsection{Nhóm 2: Bệnh trung bình}
...
\subsubsection{Nhóm 3: Bệnh phổ biến}
...
\subsection{So sánh với Literature}
...
% ============================================================
\section{Visualizations bổ sung cần thiết}
