...
\begin{table}[H]
\centering
\caption[Kết quả thực nghiệm từ bài báo gốc]{Tổng hợp kết quả thực nghiệm từ bài báo gốc}
...
\begin{tikzpicture}[scale=0.7, every node/.style={font=\small}]
    ...
    \draw[->] (mlp) -- (out);
\end{tikzpicture}
\caption[Vision Transformer Architecture Overview]{Vision Transformer Architecture Overview}
\end{figure}
